...
<label>
  ...
  <div class="listbox-item {classesBase}" data-testid="listbox-item" role="option" aria-selected={selected} tabindex="0" data-focusindex={selected ? 0 : null} on:keydown={onKeyDown} on:keydown on:keyup on:keypress>
