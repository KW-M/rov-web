...
export const GAME_CONTROLLER_BUTTON_CONFIG: GpadBtnConfig[] = [
    { btnName: "button_1", helpLabel: "ENABLE Thrusters / Take Control / Manual Mode", tooltipPlacement: "left" },
    { btnName: "button_2", helpLabel: "STOP Thrusters", tooltipPlacement: "left" },
    { btnName: "button_3", helpLabel: "Stablize Mode", tooltipPlacement: "left" },
