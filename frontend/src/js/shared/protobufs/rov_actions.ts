...
export interface RovAction {
     ...
     *
     * @generated from protobuf field: optional rov_actions_proto.ActionBackendMetadata BackendMetadata = 1 [json_name = "BackendMetadata"];
     */
    backendMetadata?: ActionBackendMetadata;
    /**
...
export interface RovResponse {
     ...
     *
     * @generated from protobuf field: optional rov_actions_proto.ResponseBackendMetadata BackendMetadata = 1 [json_name = "BackendMetadata"];
     */
    backendMetadata?: ResponseBackendMetadata; // optional
    /**
...
class RovAction$Type extends MessageType<RovAction> {
    constructor() {
        super("rov_actions_proto.RovAction", [
            { no: 1, name: "BackendMetadata", kind: "message", jsonName: "BackendMetadata", T: () => ActionBackendMetadata },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RovAction): RovAction {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* optional rov_actions_proto.ActionBackendMetadata BackendMetadata = 1 [json_name = "BackendMetadata"];*/ 1:
                    message.backendMetadata = ActionBackendMetadata.internalBinaryRead(reader, reader.uint32(), options, message.backendMetadata);
                    break;
    ...
    internalBinaryWrite(message: RovAction, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* optional rov_actions_proto.ActionBackendMetadata BackendMetadata = 1 [json_name = "BackendMetadata"]; */
        if (message.backendMetadata)
            ActionBackendMetadata.internalBinaryWrite(message.backendMetadata, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
...
class RovResponse$Type extends MessageType<RovResponse> {
    constructor() {
        super("rov_actions_proto.RovResponse", [
            { no: 1, name: "BackendMetadata", kind: "message", jsonName: "BackendMetadata", T: () => ResponseBackendMetadata },
            { no: 2, name: "ExchangeId", kind: "scalar", jsonName: "ExchangeId", opt: true, T: 5 /*ScalarType.INT32*/ },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RovResponse): RovResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* optional rov_actions_proto.ResponseBackendMetadata BackendMetadata = 1 [json_name = "BackendMetadata"];*/ 1:
                    message.backendMetadata = ResponseBackendMetadata.internalBinaryRead(reader, reader.uint32(), options, message.backendMetadata);
                    break;
                case /* optional int32 ExchangeId = 2 [json_name = "ExchangeId"];*/ 2:
                    message.exchangeId = reader.int32();
                    break;
    ...
    internalBinaryWrite(message: RovResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* optional rov_actions_proto.ResponseBackendMetadata BackendMetadata = 1 [json_name = "BackendMetadata"]; */
        if (message.backendMetadata)
            ResponseBackendMetadata.internalBinaryWrite(message.backendMetadata, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* optional int32 ExchangeId = 2 [json_name = "ExchangeId"]; */
        if (message.exchangeId !== undefined)
            writer.tag(2, WireType.Varint).int32(message.exchangeId);
