import{s as L,e as u,a as C,c as m,b as g,f as h,g as D,i as d,F as v,G as S,j as R,k as y,n as w,m as b,o as _,y as x,H as V,A as F}from"./scheduler.CbIxNoKh.js";import{S as I,i as A}from"./index.DZKcd6DY.js";import{r as P,l as j,p as q,q as G}from"./modals.DgpMqArF.js";import{g as W,c as O,a as B,s as U,b as Y,d as k}from"./twgl-full.module.D7wMvv0r.js";function X(a){let n,e,o,t,s;return{c(){n=u("div"),e=u("div"),o=C(),t=u("div"),this.h()},l(l){n=m(l,"DIV",{class:!0,style:!0});var r=g(n);e=m(r,"DIV",{class:!0}),g(e).forEach(h),o=D(r),t=m(r,"DIV",{class:!0,id:!0}),g(t).forEach(h),r.forEach(h),this.h()},h(){d(e,"class","line svelte-1l5shjg"),d(t,"class","bg svelte-1l5shjg"),d(t,"id","compassDiscImg"),v(t,"transform",`translateX(${a[0]}px)`),d(n,"class",s=S("compass left-1/2 -translate-x-1/2 overflow-hidden bg-surface-900 rounded-full box-content border-slate-700 border-2 "+a[1].class||"")+" svelte-1l5shjg"),v(n,"height","34px"),v(n,"min-width","200px")},m(l,r){R(l,n,r),y(n,e),y(n,o),y(n,t)},p(l,[r]){r&1&&v(t,"transform",`translateX(${l[0]}px)`),r&2&&s!==(s=S("compass left-1/2 -translate-x-1/2 overflow-hidden bg-surface-900 rounded-full box-content border-slate-700 border-2 "+l[1].class||"")+" svelte-1l5shjg")&&d(n,"class",s)},i:w,o:w,d(l){l&&h(n)}}}function M(a,n,e){let o;return b(a,P,t=>e(0,o=t)),a.$$set=t=>{e(1,n=_(_({},n),x(t)))},n=x(n),[o,n]}class nn extends I{constructor(n){super(),A(this,n,M,X,L,{})}}const N=`precision mediump float;
...
`;function J(a){let n,e,o;return{c(){n=u("div"),e=u("canvas"),this.h()},l(t){n=m(t,"DIV",{class:!0});var s=g(n);e=m(s,"CANVAS",{id:!0,width:!0,height:!0,class:!0}),g(e).forEach(h),s.forEach(h),this.h()},h(){d(e,"id","AHRS-display"),d(e,"width","100"),d(e,"height","100"),d(e,"class","w-full aspect-square"),d(n,"class",o="border-2 shadow-md rounded-md p-2 "+a[2].bg+" "+a[2].border+" "+a[1])},m(t,s){R(t,n,s),y(n,e),a[9](e)},p(t,[s]){s&2&&o!==(o="border-2 shadow-md rounded-md p-2 "+t[2].bg+" "+t[2].border+" "+t[1])&&d(n,"class",o)},i:w,o:w,d(t){t&&h(n),a[9](null)}}}function K(a,n,e){let o,t,s,l;b(a,j,c=>e(6,t=c)),b(a,q,c=>e(7,s=c)),b(a,P,c=>e(8,l=c));let r;const z=W(),E=`
      attribute vec4 position;
      void main() {
        gl_Position = position;
      }
  `;let i,f,p;V(()=>{if(e(3,i=r.getContext("webgl")),!i){G("Unable to initialize WebGL. Your browser or machine may not support it.");return}e(4,f=O(i,[E,N])),e(5,p=B(i,{position:[-1,-1,0,1,-1,0,-1,1,0,-1,1,0,1,-1,0,1,1,0]}))});function H(c){F[c?"unshift":"push"](()=>{r=c,e(0,r)})}return a.$$set=c=>{e(11,n=_(_({},n),x(c)))},a.$$.update=()=>{if(e(1,o=`${n.class??""}`),a.$$.dirty&504&&f&&i){i.viewport(0,0,i.canvas.width,i.canvas.height);const c={yaw:l*(3.14/180)*-1,pitch:s*(3.14/180)*-1,roll:t*(3.14/180),resolution:[i.canvas.width,i.canvas.height]};i.useProgram(f.program),U(i,f,p),Y(f,c),k(i,p)}},n=x(n),[r,o,z,i,f,p,t,s,l,H]}class en extends I{constructor(n){super(),A(this,n,K,J,L,{})}}export{nn as C,en as Y};
//# sourceMappingURL=YawRollViz.DerS_8_6.js.map
