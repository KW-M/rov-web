...
# xvfb-run python3 ff_test.py

# FIREFOX_EXECUTABLE = "/Applications/Firefox Nightly.app/Contents/MacOS/firefox"
...
# user_pref("devtools.debugger.remote-port", 9224);
...
def run_firefox():
    ...
    # create the profile preferences file
...
lockuser_pref("toolkit.crashreporter.enabled", false);
...
"""
    ...
    os.system(
        '"'
        + FIREFOX_EXECUTABLE
        + '" --new-instance --headless --start-debugger-server 9224  --profile "'
        + profile_dir
        + '" --url "'
        + URL
        + '"'
